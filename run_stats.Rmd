...
max_winstreaks = append(max_winstreaks,n_rot_wins)
```


```{r}
# print(curr_winstreaks)
# print(max_winstreaks)
# print(curr_lossstreaks)
# print(max_lossstreaks)
# print(curr_rot_info[[2]])


if(curr_winstreaks[5] != 0){
  cat(sprintf("The current rotating streak is %s consecutive wins, with %s as the next character\n",curr_winstreaks[5],curr_rot_info[[2]]))
}else{
...
if(curr_lossstreaks[1] == 0){
  cat(sprintf("The Ironclad is currently on a win streak of %s\n",curr_winstreaks[1]))
}else{
  cat(sprintf("The Ironclad is currently on a loss streak of %s\n",curr_lossstreaks[1]))
}
if(curr_lossstreaks[2] == 0){
  cat(sprintf("The Silent is currently on a win streak of %s\n",curr_winstreaks[2]))
}else{
  cat(sprintf("The Silent is currently on a loss streak of %s\n",curr_lossstreaks[2]))
}
if(curr_lossstreaks[3] == 0){
  cat(sprintf("The Defect is currently on a win streak of %s\n",curr_winstreaks[3]))
}else{
  cat(sprintf("The Defect is currently on a loss streak of %s\n",curr_lossstreaks[3]))
}
if(curr_lossstreaks[4] == 0){
  cat(sprintf("The Watcher is currently on a win streak of %s\n",curr_winstreaks[4]))
}else{
  cat(sprintf("The Watcher is currently on a loss streak of %s\n",curr_lossstreaks[4]))
}
